...
class AppHomeFavorites extends LitElement {
...
class AppInfoCard extends LitElement {
...
class AppHomeDashboard extends LitElement {
    ...
    render() {
        ...
        return html`
            ...
            <div class="dashboard-items-container">
                <app-info-card class="recovery-info-card" .data="${this.getRecoveryData()}"></app-info-card>

                <app-info-card class="confirmed-info-card" .data="${this.getConfirmedData()}"></app-info-card>

                <app-info-card class="deaths-info-card" .data="${this.getDeathData()}"></app-info-card>
            </div>
        `;
    }
    ...
    getRecoveryData() {
        return {
            ...
            value1: this.globalSummary.NewRecovered.toString(),
            caption2: "Total Recovered",
            value2: this.globalSummary.TotalRecovered.toString(),
        }
    }
    ...
    getConfirmedData() {
        return {
            ...
            value1: this.globalSummary.NewConfirmed.toString(),
            caption2: "Total Confirmed",
            value2: this.globalSummary.TotalConfirmed.toString(),
        }
    }
    ...
    getDeathData() {
        return {
            ...
            caption1: "New Deaths",
            value1: this.globalSummary.NewDeaths.toString(),
            caption2: "Total Deaths",
            value2: this.globalSummary.TotalDeaths.toString(),
        }
    }
...
class AppCountryInfoCard extends LitElement {
...
class AppLineChart extends LitElement {
...
class AppPieChart extends LitElement {
